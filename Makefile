...
run_dev:
	go run main.go dspace.go -name Ihar@mw-publications -pass 71b1nbj468uvp9fq9urctumi2qn37778 -mediawiki http://hefty.local/~ihar/ims/1.32.2 -section "Staff" -page "Secure:Alumni"
